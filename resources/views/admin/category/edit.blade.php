...
<div class="main-panel">
    <div class="heading-section">
        <div class="d-flex align-items-center">
            <div class="mr-auto">
                <h4 class="heading-title">Update Category</h4>
            </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="category_name" class="form-control {{$errors->first('category_name')?'is-invalid':''}}" placeholder="Category Name" value="{{$category->name}}" />
                            ...
                            <div class="form-group">
                                ...
                                <select name="status" class="form-control">
                                    ...
                                    @foreach(status_array() as $key=>$row)
                                        <option value="{{$key}}" @if($key==$category->status) selected @endif>{{$row}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
