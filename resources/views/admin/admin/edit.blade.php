...
<div class="main-panel">
    ...
    <div class="di-section">
        <div class="add-form-info">
            <form class="" method="post" enctype="multipart/form-data" id="user-form" autocomplete="off">
            @csrf
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="password" name="password" id="password" class="form-control {{$errors->first('password')?'is-invalid':''}}" placeholder="Optional" autocomplete="off"/>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="password" name="password_confirmation" class="form-control {{$errors->first('password_confirmation')?'is-invalid':''}}" placeholder="Optional" autocomplete="off" />
                            ...
                            <div class="form-group">
                                ...
                                <select name="status" class="form-control">
                                    ...
                                    @foreach(status_array() as $key=>$row)
                                        <option value="{{$key}}" @if($key==$user->status) selected @endif>{{$row}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div> 
