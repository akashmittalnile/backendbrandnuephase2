...
<div class="main-panel">
    <div class="heading-section">
        <div class="d-flex align-items-center">
            <div class="mr-auto">
                <h4 class="heading-title">Instructional Template List</h4>
            </div>
            <div class="btn-option-info">
                <a href="{{ route('admin.instructional.template.create') }}" class="btn-ye">Add New Instructional Template</a>
            </div>
        </div>
    </div>
            ...
            <table class="table table-bordered">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('admin.instructional.template.edit',$row) }}" class="btn btn-warning btn-sm"><i class="fa fa-edit"></i></a>
                            <a href="{{ route('admin.instructional.template.show',$row) }}" class="btn btn-success btn-sm"><i class="fa fa-eye"></i></a>
                            <a href="javascript:void(0)" data-url="{{ route('admin.instructional.template.delete',$row) }}" class="btn btn-danger btn-sm delete-template"><i class="fa fa-trash"></i></a>
                        </td>
                    </tr>
                    @empty
                    <tr>
