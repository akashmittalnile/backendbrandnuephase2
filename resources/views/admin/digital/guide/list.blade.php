...
<div class="main-panel">
    <div class="heading-section">
        <div class="d-flex align-items-center">
            <div class="mr-auto">
                <h4 class="heading-title">Resources/Guides List</h4>
            </div>
            <div class="btn-option-info">
                <a href="{{ route('admin.instructional.guide.create') }}" class="btn-ye">Add New Resources Guide</a>
            </div>
        </div>
    </div>
            ...
            <table class="table table-bordered">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('admin.instructional.guide.edit',$row) }}" class="btn btn-warning btn-sm"><i class="fa fa-edit"></i></a>
                            <a href="{{ route('admin.instructional.guide.show',$row) }}" class="btn btn-success btn-sm"><i class="fa fa-eye"></i></a>
                            <a href="javascript:void(0)" data-url="{{ route('admin.instructional.guide.delete',$row) }}" class="btn btn-danger btn-sm delete-guide"><i class="fa fa-trash"></i></a>
                        </td>
                    </tr>
                    @empty
                    <tr>
