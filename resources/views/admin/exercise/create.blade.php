...
<div class="main-panel">
    <div class="heading-section">
        <div class="d-flex align-items-center">
            <div class="mr-auto">
                <h4 class="heading-title">Add New Exercise</h4>
            </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="exercise_name" class="form-control {{$errors->first('exercise_name')?'is-invalid':''}}" placeholder="Exercise Name" value="{{old('exercise_name')}}" />
