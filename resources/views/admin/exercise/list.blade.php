...
<div class="main-panel">
    <div class="heading-section">
        <div class="d-flex align-items-center">
            <div class="mr-auto">
                <h4 class="heading-title">Exercise List</h4>
            </div>
            <div class="btn-option-info">
                <a href="{{ route('admin.exercise.create') }}" class="btn-ye">Add New Exercise</a>
            </div>
        </div>
    </div>
            ...
            <table class="table table-bordered">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('admin.exercise.edit',$row) }}" class="btn-edit-sm"><i class="fa fa-edit"></i></a>
                            <a href="javascript:void(0)" data-url="{{ route('admin.exercise.delete',$row) }}" class="btn-delete-sm delete-exercise"><i class="fa fa-trash"></i></a>
                        </td>
                    </tr>
                    @empty
                        <tr>
