...
<div class="main-panel">
    <div class="heading-section">
        <div class="d-flex align-items-center">
            <div class="mr-auto">
                <h4 class="heading-title">Add New Notification</h4>
            </div>
            ...
            <div class="upload-video-form">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <textarea name="description" class="form-control {{$errors->first('description')?'is-invalid':''}}" placeholder="Description" ></textarea>
                ...
                <div class="add-form-checkbox">
                    <div class="form-checkbox">
                        <input type="checkbox" value="Y" id="Mark as publish" name="status" />
                        <label for="Mark as publish">Mark as publish</label>
                    </div>
                </div>
                <div class="add-form-btn"> 
                    <button class="btn-publish" type="submit">Create</button>
                </div>
            </div>
            </form>
        </div>
