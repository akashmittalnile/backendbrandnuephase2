                ...
                <tr>                    
                    ...
                    <tr>
                        <td align="center" colspan="4">
                            <a href="{{ url('password/reset', $token).'?email='.urlencode($user->email) }}" style="color: #fff; background: #b51f38; border-radius: 40px; padding: 13px 52px; border:none; margin-bottom: 25px; display: inline-block;">
                                Reset Your Password
                            </a>
                        </td>
                    </tr>
