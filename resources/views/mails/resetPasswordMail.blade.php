                    ...
                    <tr>
                        <td style=" padding: 16px 0 16px 16px;" valign="top">
                            <table align="left" bgcolor="#FFF" border="0" cellpadding="0" cellspacing="0" width="50%">
                                <tr>
                                    <td>
                                        <img alt="" border="0" src="{{ asset('admin/images/logo.svg') }}" style="margin:0; padding:0; display:block;" width="120px"/>
                                    </td>
                                </tr>
                            </table>
                        </td>
                ...
                <tr>                    
                    <tr>
                        <td colspan="4" style="padding: 16px;">
                            ...
                            <p>
                                The password for your Reverse Gear ID ({{$user->email}}) has been successfully changed.
                            </p>
                            <p>
                                Should you have any questions or want more information about our service, please email us at admin@newtownhealth.com.
                            </p>
                            <p>
                                Thank you.
                            </p>
                    ...
                    <tr>
                        <td align="center" colspan="4">                            
                            <a href="{{ url('/') }}" style="color: #fff; background: #b51f38; border-radius: 40px; padding: 13px 52px; border:none; margin-bottom: 25px; display: inline-block;">
                                Login your account
                            </a>
                        </td>
                    </tr>
                            ...
                            <tr>
                                <td align="center" class="mobile" style="color: #fff; font-size: 12px; font-weight: 500" valign="top" width="100%">
                                    <p style="margin: 10px 0px;">
                                        Mail us: admin@newtownhealth.com
                                    </p>
                                </td>
                            </tr>
                            <tr>
